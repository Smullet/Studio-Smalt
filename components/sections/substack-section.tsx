...
export const SubstackSection = () => {
  ...
  return (
    <section className="py-24 flex flex-col w-full items-center justify-center relative">
      <motion.div
        className="flex flex-col w-full max-w-[1046px] items-center gap-12 relative px-4"
        initial="hidden"
        animate="visible"
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center gap-5 relative self-stretch w-full">
            <motion.h2
              className="relative self-stretch mt-[-1.00px] font-normal text-5xl text-center tracking-[0] leading-[52.8px] whitespace-nowrap font-['Helvetica_Neue-Bold',Helvetica]"
              variants={itemVariants}
            >
            ...
            <motion.p
              className="max-w-[913px] opacity-70 font-normal text-[#191818] text-lg text-center tracking-[-0.18px] leading-[25.2px] font-['Inter',Helvetica] px-4"
              variants={itemVariants}
            >
        ...
        <motion.div variants={itemVariants}>
          <Card className="w-full max-w-[820px] bg-[#f6f7f9] rounded-[34px] border-none overflow-hidden">
            <CardContent className="p-8">
              <div className="flex flex-col items-center gap-6">
                <h3 className="text-2xl font-bold text-[#123293] font-['Helvetica_Neue-Bold',Helvetica]">
                  Abonnez-vous à ma newsletter
                </h3>

                <p className="text-center text-[#191818] opacity-80 text-base font-['Inter',Helvetica]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-[820px]">
          {blogPosts.map((post, index) => (
            <motion.div key={post.id} variants={cardVariants} custom={index}>
              <Card className="bg-white border border-[#e7e8f0] rounded-xl overflow-hidden hover:shadow-md transition-shadow duration-300">
