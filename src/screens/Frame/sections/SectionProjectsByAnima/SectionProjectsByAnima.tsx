...
export const SectionProjectsByAnima = (): JSX.Element => {
    ...
    <section className="py-24 flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-center px-6 max-w-[1200px] w-full">
        <div className="flex flex-col items-center gap-12 max-w-[952px]">
          <h2 className="text-5xl font-bold text-center leading-[52.8px] tracking-normal max-w-[691px]">
          ...
          <div className="flex flex-col items-center gap-[30px] w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full">
              {approachSteps.slice(0, 2).map((step) => (
                <Card key={step.id} className={`${step.bgColor} rounded-[30px] overflow-hidden border-none h-[494px]`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full">
              {approachSteps.slice(2, 4).map((step) => (
                <Card key={step.id} className={`${step.bgColor} rounded-[30px] overflow-hidden border-none h-[492px]`}>
                  <CardContent className="flex items-start gap-[50px] p-10">
                    <div className={`text-[90px] font-normal tracking-[-1.04px] leading-[90px] ${step.textColor}`}>
                      {step.id}
                    </div>
